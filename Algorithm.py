...
#    by adding or removing the functions you want to test   #
#              for your Automata and Diagnoser.             #
#                                                           #
#  To run this program it with your Automata and Diagnoser  #
#     files, export them to .xml format and put them on     #
#  the same folder as this module. Then, change the modules #
#   AutomataParser.py and DiagnoserParser.py respectively,  #
#               for them to parse your files.               #
#          This is made on line 2 of each module.           #
#                                                           #
# Developers:                                               #
#   Giovanna Sponchiado                                     #
#   Ludimilla Freitas                                       #
